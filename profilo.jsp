		...
		<%
			...
			try{
				...
				while(result.next()){
					...
					if(azienda!=null){
						out.println("<input type='text' name='settore' placeholder="+result.getString(13)+" readonly> <br>");
						out.println("<input type='text' name='ndip' placeholder="+result.getString(14)+" > <br>");
					}
					else{
						out.println("<input type='text' name='cognome' placeholder="+result.getString(9)+" readonly> <br>");
						out.println("<input type='text' name='nascita' placeholder="+result.getString(10)+" > <br>");
						out.println("<input type='text' name='livstudio' placeholder="+result.getString(11)+" readonly> <br>");
