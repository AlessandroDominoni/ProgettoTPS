	...
	<body>
		...
		<%
			...
			try{
				...
				while(result.next()){
					out.println("<input type='text' name='nomeazienda' value="+result.getString(2)+" readonly> <br>");
					out.println("<input type='text' name='contratto' placeholder="+result.getString(3)+" > <br>");
					out.println("<input type='text' name='orario' placeholder="+result.getString(4)+"> <br>");
					out.println("<input type='text' name='professione' placeholder="+result.getString(5)+"> <br>");
					out.println("<input type='text' name=descrizione' placeholder="+result.getString(6)+"> <br>");
